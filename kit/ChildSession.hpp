...
private:
    ...
    bool insertPicture(const char* buffer, int length, const std::vector<std::string>& tokens, bool isChange = false);
    ...
    bool getGraphicSelection(const char* buffer, int length, const std::vector<std::string>& tokens);
